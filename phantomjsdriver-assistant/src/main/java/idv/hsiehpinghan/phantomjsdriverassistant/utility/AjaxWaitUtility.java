...
import idv.hsiehpinghan.phantomjsdriverassistant.webelement.Select;
import idv.hsiehpinghan.phantomjsdriverassistant.webelement.Select.Option;
import idv.hsiehpinghan.phantomjsdriverassistant.webelement.Table;
import idv.hsiehpinghan.phantomjsdriverassistant.webelement.TextInput;
import idv.hsiehpinghan.phantomjsdriverassistant.webelement.WebElementBase;
...
public class AjaxWaitUtility {
	 ...
	 * @return
	 */
	public static boolean waitUntilOptionsDifferent(final Select select, final List<Option> comparedOption) {
	 ...
	 * @return
	 */
	public static boolean waitUntilRowTextEqual(final Table table, final int rowIndex,
			final List<String> comparedList) {
		return wait(new Function<Void, Boolean>() {
			@Override
			public Boolean apply(Void v) {
				try {
	 ...
	 * @return
	 */
	public static boolean waitUntilTextEqual(final WebElementBase webElement, final String text) {
		return wait(new Function<Void, Boolean>() {
			@Override
			public Boolean apply(Void v) {
				try {
	 ...
	 * @return
	 */
	public static boolean waitUntilTextDifferent(final WebElementBase webElement, final String text) {
		return wait(new Function<Void, Boolean>() {
			@Override
			public Boolean apply(Void v) {
				try {
	 ...
	 * @return
	 */
	public static boolean waitUntilValueEqual(final TextInput TextInput, final String value) {
		return wait(new Function<Void, Boolean>() {
			@Override
			public Boolean apply(Void v) {
				try {
	 ...
	 * @return
	 */
	public static boolean waitUntilTextStartWith(final WebElementBase webElement, final String text) {
		return wait(new Function<Void, Boolean>() {
			@Override
			public Boolean apply(Void v) {
				try {
	 ...
	 * @return
	 */
	public static boolean waitUntilTextEndWith(final WebElementBase webElement, final String text) {
		return wait(new Function<Void, Boolean>() {
			@Override
			public Boolean apply(Void v) {
				try {
