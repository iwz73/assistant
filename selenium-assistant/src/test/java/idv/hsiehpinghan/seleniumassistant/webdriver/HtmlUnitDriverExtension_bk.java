...
public class HtmlUnitDriverExtension_bk extends HtmlUnitDriver {
	private static final String CONTENT_DISPOSITION = "Content-disposition";
	private Logger logger = Logger.getLogger(this.getClass().getName());

	public HtmlUnitDriverExtension_bk() {
		super();
	}

	public HtmlUnitDriverExtension_bk(boolean enableJavascript) {
		super(enableJavascript);
	}

	public HtmlUnitDriverExtension_bk(BrowserVersion version,
