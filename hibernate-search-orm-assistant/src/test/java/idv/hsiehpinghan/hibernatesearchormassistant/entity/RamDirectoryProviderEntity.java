...
@Entity
@Indexed
public class RamDirectoryProviderEntity implements Serializable {
	...
	@Field
	private Class<RamDirectoryProviderEntity> clazz;
	...
	public Class<RamDirectoryProviderEntity> getClazz() {
		return clazz;
	}

	public void setClazz(Class<RamDirectoryProviderEntity> clazz) {
		this.clazz = clazz;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RamDirectoryProviderEntity other = (RamDirectoryProviderEntity) obj;
		if (id == null) {
			if (other.id != null)
				return false;
