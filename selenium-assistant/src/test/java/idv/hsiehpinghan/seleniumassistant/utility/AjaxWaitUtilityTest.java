...
public class AjaxWaitUtilityTest {
	...
	public void waitUntilOptionsDifferent() {
		...
		Assert.assertTrue(AjaxWaitUtility.waitUntilOptionsDifferent(s2, s.getOptions()));
	}
	...
	public void waitUntilOptionsDifferent2() {
		...
		Assert.assertTrue(AjaxWaitUtility.waitUntilOptionsDifferent(s3, s.getOptions()));
	}
