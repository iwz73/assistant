...
public class BookStore extends TableImpl<BookStoreRecord> {
    ...
    private static final long serialVersionUID = -285533708;

    /**
     * The reference instance of <code>jooq_assistant.book_store</code>
     */
    ...
    /**
     * The column <code>jooq_assistant.book_store.name</code>.
     */
    ...
    /**
     * Create a <code>jooq_assistant.book_store</code> table reference
     */
    public BookStore() {
    ...
    /**
     * Create an aliased <code>jooq_assistant.book_store</code> table reference
     */
