...
public class FlatFileDelimitedTest extends AbstractTestNGSpringContextTests {
	@Autowired
	private JobLauncher jobLauncher;
	@Autowired
	@Qualifier("flatFileDelimitedJob")
	private Job job;
	...
	public void test() throws Exception {
		...
		jobParametersBuilder.addString("inputResource",
				"/home/thank/git/assistant/spring-batch-assistant/src/test/data/flatFileDelimited");
		...
		jobParametersBuilder.addString("outputResource", "/tmp/flatFileDelimited");
