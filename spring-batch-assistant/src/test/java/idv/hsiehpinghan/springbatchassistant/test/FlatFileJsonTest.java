...
public class FlatFileJsonTest extends AbstractTestNGSpringContextTests {
	@Autowired
	private JobLauncher jobLauncher;
	@Autowired
	@Qualifier("flatFileJsonJob")
	private Job job;
	...
	public void test() throws Exception {
		...
		jobParametersBuilder.addLong("linesToSkip", 0L);
		jobParametersBuilder.addString("strict", "true");
		jobParametersBuilder.addString("inputResource",
				"/home/thank/git/assistant/spring-batch-assistant/src/test/data/flatFileJson");
		...
		jobParametersBuilder.addString("outputResource", "/tmp/flatFileJson");
