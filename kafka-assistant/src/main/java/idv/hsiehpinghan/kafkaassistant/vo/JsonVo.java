...
public class JsonVo {
	...
	public JsonVo(Boolean _boolean, Integer _integer, Float _float, String _string, _Object _object,
			List<String> _array, List<_Object> _object_array, String _null) {
		super();
	...
	public String toString() {
		return "JsonVo [_boolean=" + _boolean + ", _integer=" + _integer + ", _float=" + _float + ", _string=" + _string
				+ ", _object=" + _object + ", _array=" + _array + ", _object_array=" + _object_array + ", _null="
				+ _null + "]";
	}
	...
	public static class _Object {
		...
		public _Object(Integer _integer, String _string) {
			super();
			this._integer = _integer;
			this._string = _string;
		}
