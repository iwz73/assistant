...
public class MultiResourceTest extends AbstractTestNGSpringContextTests {
	@Autowired
	...
	public void test() throws Exception {
		...
		jobParametersBuilder.addString("inputResources",
				"/home/thank/git/assistant/spring-batch-assistant/src/test/data/multiResource/multiResource_*");
