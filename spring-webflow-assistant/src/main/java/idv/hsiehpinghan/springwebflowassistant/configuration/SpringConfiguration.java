package idv.hsiehpinghan.springwebflowassistant.configuration;
...
@Configuration
@ImportResource("classpath:/springWebflowConfiguration.xml")
@ComponentScan(basePackages = { "idv.hsiehpinghan.springwebflowassistant" })
